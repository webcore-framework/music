export default class CantoneseView extends webcore.component.builder {

    static tag = 'view-cantonese';

    create(){
        this.styles(':host{display:block}.root{position:relative}')
        .template('/views/cantonese/cantonese.html')
        .mode('closed')
        .inject(['http']);
    }
