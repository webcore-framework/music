export default class SoundtrackView extends webcore.component.builder {

    static tag = 'view-soundtrack';

    create(){
        this.styles(':host{display:block}.root{position:relative}')
        .template('/views/soundtrack/soundtrack.html')
        .mode('closed')
        .inject(['http']);
    }
